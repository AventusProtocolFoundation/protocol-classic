...
interface IMembersManager {
  ...
  /**
  * @return Timestamp of when this member can be deregistered; zero if no restrictions.
  */
  function getDeregistrationTime(address _memberAddress, string calldata _memberType) external view
