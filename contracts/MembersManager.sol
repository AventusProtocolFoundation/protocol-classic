...
contract MembersManager is IMembersManager, Owned, Versioned {
    ...
    function getNewMemberDeposit(string calldata _type)
      external
      view
    ...
    function getDeregistrationTime(address _memberAddress, string calldata _memberType)
      external
      view
      returns (uint deregistrationTime_)
    {
      deregistrationTime_ = LMembers.getDeregistrationTime(s, _memberAddress, _memberType);
    }
}