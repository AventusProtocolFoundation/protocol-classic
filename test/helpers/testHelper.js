...
let aventusStorage, versioned, proposalsManager, membersManager, avtManager, eventsManager, avtIERC20;
let profiledLogArgs = profilingHelper.profileFunction('TestHelper.getLogArgs', getLogArgs);
let lastEventBlockNumber = -1;

async function init() {
  avtFaucet = await AVTFaucet.deployed();
