...
async function getTicketOwnerPermission(_eventId, _ticketId, _currentOwner, _sender) {
  const msgHash = hash(_eventId, _ticketId, _currentOwner, _sender);
  return sign(msgHash, _currentOwner);
}
