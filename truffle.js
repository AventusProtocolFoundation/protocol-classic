...
module.exports = {
  networks: {
    development: {
      ...
      port: 8545,
      network_id: "*",
      gas: 8000000 // Match the lower of the mainnet/rinkeby values where possible
    },
    rinkeby: {
      provider: () => getWalletProvider(),
      network_id: 4,
      gas: 7000000, // See https://www.rinkeby.io/#stats to make sure this is not over the network limit
      gasPrice: 20e9 // see latest blocks on https://www.rinkeby.io/#stats for reasonable prices
    },
    mainnet: {
      provider: () => getWalletProvider(),
      network_id: 1,
